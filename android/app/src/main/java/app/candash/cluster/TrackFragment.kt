...
import app.candash.cluster.databinding.FragmentTrackBinding
...
class TrackFragment : Fragment() {
    ...
    private fun updateAutopilotUI(autopilotStateVal: Int, steeringAngleVal: Int?) {
        ...
        binding.wheel.visibility = View.VISIBLE
            ...
            //binding.wheel.pivotX = (binding.autopilot.width / 2).toFloat()
            //binding.wheel.pivotY = (binding.autopilot.height / 2).toFloat()
            binding.wheel.rotation = 45f//steeringAngle.toFloat()
    }
}